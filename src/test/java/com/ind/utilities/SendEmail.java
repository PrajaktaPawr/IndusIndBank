...
public class SendEmail {
    ...
    public static void mail(int totalTestCases,int passCount,int failedCount) {
        ...
        String[] recipients = {
        		...
        		"prajakta.pawar@cogniwize.com",
        		"prasad.kusundal@cogniwize.com"
        ...
        final String senderEmail = "prajaktapawar.pp@gmail.com";
        final String senderPassword = "mpxurhpxzqqgdtrp";
        ...
        try {
            ...
            File file = new File("C:\\Users\\Prajakat_Pawar\\eclipse-workspace\\IndusindBank\\datafiles\\TestData..xlsx"); 
